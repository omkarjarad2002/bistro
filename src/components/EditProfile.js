...
function EditProfile() { 
  ...
  return (
    ...
    <h3><Link style={{color:"black", cursor:"initial"}} to="">Enter only those which you want to Update :)</Link></h3>
        <div className="container1 container">
          <div className="contact__container">
            ...
            <button className='btn btn-primary mb-3' onClick={PostData}>Save Changes</button>
          </div>
        </div> 
